...
import { Check, Star, Crown, Rocket, Lightbulb, Gift, ArrowLeft, Calculator } from "lucide-react";
  ...
  const addOns = [
    {
      ...
      description: "Additional automated WhatsApp messages beyond your plan limit",
      icon: "💬",
    },
    {
      ...
      price: "₹5,000",
      unit: "per year",
      description: "Custom branded mobile app for your customers with your salon's branding",
      icon: "📱",
    },
    {
      ...
      price: "₹10,000",
      unit: "per year",
      description: "Enhanced multi-location management with advanced analytics and controls",
      icon: "🏢",
    },
    {
      ...
      price: "₹15,000",
      unit: "one-time setup",
      description: "Connect with your existing POS, accounting, or other business software",
      icon: "🔗",
    },
  ]
  ...
  return (
    ...
    <section className="relative py-20 overflow-hidden ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Back to Home Link */}
          <Link to="/" className="inline-flex items-center text-white/80 hover:text-white mb-8 transition-colors group bg-green-800 p-2 rounded-3xl ">
          ...
          <div className="text-center fade-in-up">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">
              No contracts. No hidden fees. Cancel anytime. Start with a 7-day free trial and see the difference.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="glass-effect p-6 rounded-2xl border border-white/20">
                <div className="text-3xl font-bold text-yellow-300 mb-2">24hrs</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {addOns.map((addon, index) => (
              ...
              >
                ...
                <div className="text-2xl font-bold text-blue-600 mb-2">
                  {addon.price}
                  <span className="text-sm text-gray-800 font-normal">/{addon.unit}</span>
                </div>
                <p className="text-gray-800 text-sm leading-relaxed">{addon.description}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <div className="bg-gradient-to-r from-green-800 to-green-900 rounded-xl p-8 text-center flex flex-col items-center text-white">
          <h3 className="text-2xl font-bold mb-2 flex items-center">
            <Gift className=" w-6 h-6 text-red-600 fill-yellow-400" /> Launch
            Offer
          </h3>
