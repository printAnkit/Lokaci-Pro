      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="flex flex-col items-center gap-4 mb-10">
          <div>
            ...
            <p className="text-gray-700 text-lg font-semibold text-center mb-10 max-w-5xl mx-auto">
              ...
              time slots make you the most money and use those insights to grow
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-gray-700 mb-6">
            With Profit Intelligence, you’re not just running your business -
            you’re growing it with clarity and confidence.
          </p>
          <Link
            to="/get-started"
